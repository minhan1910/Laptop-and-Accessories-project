    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <form action="<?php echo e(route('admin.users.update', $userInfo->id)); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="name">Fullname</label>
                                <input type="text" class="form-control" placeholder="Enter fullname..."
                                    value="<?php echo e(old('name') ?? $userInfo->name); ?>" name="name">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter user's email" name="email"
                                    value="<?php echo e(old('email') ?? $userInfo->email); ?>">
                            ...
                            <div class="address d-flex">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Street" name="street"
                                        value="<?php echo e(old('street') ?? $userInfo->street); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter ward" name="ward"
                                        value="<?php echo e(old('ward') ?? $userInfo->ward); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter district" name="district"
                                        value="<?php echo e(old('district') ?? $userInfo->district); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role">
                                    ...
                                    <?php if(!empty('roleList')): ?>
                                        <?php $__currentLoopData = $roleList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>"
                                                <?php echo e(old('role') ?? $userInfo->role_id == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row">
                                ...
                                <a href="<?php echo e(route('admin.users.index')); ?>"class="btn btn-danger mb-5 ml-4 text-white">Back
                                    to
                                    Home</a>
                            </div>
                        </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\OneDrive\Desktop\App\School\test\Laptop-and-Accessories-project\resources\views/admin/user/edit.blade.php ENDPATH**/ ?>